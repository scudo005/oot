...
typedef struct struct_801D2E68 {
    /* 0x0 */ void (*unk_0)(n64dd_CommPacket*);
    /* 0x4 */ s32 (*unk_4)(n64dd_CommPacket*);
...
void func_801C8424(n64dd_CommPacket* arg0) {
    struct_801D2E68* temp_v0;
    s32 (*temp_s2)(n64dd_CommPacket*);
    void (*aux)(n64dd_CommPacket*);
    s32 temp_v0_2;
...
void func_801C85F0(n64dd_CommPacket* arg0, s32 arg1) {
    if (arg1 == 1) {
        func_801C8424(arg0);
    } else {
